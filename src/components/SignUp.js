    ...
    return (
        ...
        <Card elevation={10} align="center" variant="outlined" style={cardStyle}>
            ...
            <form onSubmit ={handleSubmit}>
                ...
                <h2 style={h2Style}><span style={spanStyle}>or sign up with</span></h2>
                <Button disabled={loading} type="submit" variant="outlined">Google</Button>
                <Button disabled={loading} type="submit" variant="outlined">Facebook</Button>
            </form>
         </Card>
        </Grid>
    )
